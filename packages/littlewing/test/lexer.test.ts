 ...
 */
function getNumberValue(cursor: ReturnType<typeof createCursor>, token: Token): number {
 ...
 */
function getTextValue(cursor: ReturnType<typeof createCursor>, token: Token): string {
